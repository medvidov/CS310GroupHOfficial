...
<body onload="getResults()">
	...
	<div class="container-fluid">
		<div class="row justify-content-center"
			style="padding-left: 100px; margin-top: 100px; margin-bottom: 100px;">
			<!-- images -->
			<div class="col-12 col-sm-9">
				<div class="container" id="collage" style="">
					<div class="row">
						<img src="" class="googleImage " id="1"> <img src=""
							class="googleImage " id="2"> <img src=""
							class="googleImage " id="3"> <img src=""
							class="googleImage " id="4"> <img src=""
							class="googleImage " id="5">
					</div>
					<div class="row">
						<img src="" class="googleImage " id="6"> <img src=""
							class="googleImage " id="7"> <img src=""
							class="googleImage " id="8"> <img src=""
							class="googleImage " id="9"> <img src=""
							class="googleImage " id="10">
					</div>
				</div>
			</div>
			<!-- navbar -->
			<div class="col-12 col-sm-3" style="padding-top: 50px;">
				<form action="ToList" onsubmit="return check();" method="get">
					...
					<div class="mt-20">
						<button class="btn btn-secondary wth" type="submit">Manage
							List</button>
					</div>
				</form>
				<div class="mt-20">
					<button class="btn btn-secondary wth" id="grocery"
						onclick="toGrocery();">Grocery List</button>
				</div>
				<div class="mt-20">
					<button class="btn btn-secondary wth" id="toSearch"
						onclick="toSearch();">Return to Search Page</button>
				</div>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			<!--  restaurant -->
			<div class="col-12 col-md-6" id="restList"></div>

			<!-- recipe -->

			<div class="col-12 col-md-6" id="recList"></div>
