			...
			<div col="col-4">
				<div class="mt-20">
					<a href="javascript:window.print();"><button
							class="btn btn-secondary wth">Printable View</button></a>
				</div>
				<div class="mt-20">
					<button class="btn btn-secondary wth" id="results"
						onclick="toResult();">Return To Results</button>
				</div>
				<form action="" onsubmit="return add();" method="get" id="myform">
					...
					<div class="mt-20">
						<button class="btn btn-secondary wth" type="submit">Add
							to List</button>
					</div>
				</form>
				<div class="mt-20">
					<button class="btn btn-secondary " style="width: 200px;"
						onclick="AddToGrocery();" id="addGrocery">Add to Grocery
						List</button>
				</div>
				<div id="response"
					style="margin-top: 20px; color: red; width: 150px;"></div>
			</div>
		</div>


		<div class="row"
			style="margin-left: 5px; margin-bottom: 10px; margin-top: 10px;">
